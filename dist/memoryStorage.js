...
exports.MemoryStorageMap = exports.MemoryStorage = void 0;
const transactionPoolMap_1 = __importDefault(require("./transactionPoolMap"));
const transactionMinerMap_1 = __importDefault(require("./transactionMinerMap"));
const SEIGTokenPoolMap_1 = __importDefault(require("./SEIGTokenPoolMap"));
const SEIGTokenMinerMap_1 = __importDefault(require("./SEIGTokenMinerMap"));
class MemoryStorage {
    constructor() {
        this.blockchain = [];
        this.transactionPool = [];
        this.transactionPoolMap = new transactionPoolMap_1.default();
        this.transactionMiner = [];
        this.transactionMinerMap = new transactionMinerMap_1.default();
        this.SEIGToken = [];
        this.SEIGTokenPool = [];
        this.SEIGTokenPoolMap = new SEIGTokenPoolMap_1.default();
        this.SEIGTokenMiner = [];
        this.SEIGTokenMinerMap = new SEIGTokenMinerMap_1.default();
    }
...
exports.MemoryStorageMap = MemoryStorageMap;
